...
export const ChatBubbleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 0 1-1.04-.018l-3.722-.537a5.25 5.25 0 0 0-1.04.018l-3.722.537A2.25 2.25 0 0 1 3 17.25V13c0-1.007.67-1.838 1.62-2.097M15.75 6.75v3.375c0 .621.504 1.125 1.125 1.125h3.375V13a2.25 2.25 0 0 1-2.25 2.25h-9A2.25 2.25 0 0 1 6 13V6.75a2.25 2.25 0 0 1 2.25-2.25h9A2.25 2.25 0 0 1 15.75 6.75Z" />
    </svg>
);

export const ShareIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.195.025.39.05.588.08a2.25 2.25 0 0 1 1.632 3.109m-1.632-3.109a1.686 1.686 0 0 1 2.186 0M21 12a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm0 0h-5.042M7.217 10.907l-2.472-3.238a2.25 2.25 0 0 0-3.238 0L.907 10.907M7.217 10.907l-1.313.97a2.25 2.25 0 0 0 0 3.238l1.313.97m0-4.208 2.472 3.238a2.25 2.25 0 0 0 3.238 0l2.472-3.238M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186v5.042a2.25 2.25 0 0 0 4.5 0v-5.042" />
    </svg>
);
...
export const StarIcon = (props: React.SVGProps<SVGSVGElement> & { filled?: boolean }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} strokeWidth={1.5} stroke="currentColor" {...rest}>
...
export const ShutterSpeedIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const IsoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-1.007 1.056-2.052 1.536-3.121m-1.536 3.121-2.94-2.793m2.94 2.793a3.75 3.75 0 0 1-4.13-1.659m4.13-1.659c.353-.615.626-1.255.856-1.922m.856-1.922L11.45 7.5m3.741 2.25c.353.615.626 1.255.856 1.922m.856-1.922-2.94-2.793m2.94 2.793a3.75 3.75 0 0 0-4.13-1.659m4.13-1.659c-.353-.615-.626-1.255-.856-1.922m-13.5 0a3.75 3.75 0 0 1 4.13-1.659m-4.13 1.659c-.353-.615-.626-1.255-.856-1.922m.856-1.922L4.55 7.5m5.698 2.25a3.75 3.75 0 0 0-4.13-1.659M12 2.25a3.75 3.75 0 0 0-3.75 3.75v.63c0 .597.237 1.17.659 1.591l.26 1.159a.75.75 0 0 1-1.415.487l-.26-1.16a2.25 2.25 0 0 0-2.824-1.413 2.25 2.25 0 0 0-1.583 2.824l1.16.26a.75.75 0 0 1-.487 1.415l-1.16-.26a2.25 2.25 0 0 0-2.824 1.413 2.25 2.25 0 0 0 1.583 2.824l1.16.26a.75.75 0 0 1 .487 1.415l-1.16.26a2.25 2.25 0 0 0 1.413 2.824 2.25 2.25 0 0 0 2.824-1.583l.26-1.16a.75.75 0 0 1 1.415-.487l-.26 1.16a2.25 2.25 0 0 0 2.824 1.413 2.25 2.25 0 0 0 1.583-2.824l-1.16-.26a.75.75 0 0 1 .487-1.415l1.16.26a2.25 2.25 0 0 0 2.824-1.413 2.25 2.25 0 0 0-1.583-2.824l-1.16-.26a.75.75 0 0 1-.487-1.415l1.16-.26a2.25 2.25 0 0 0-1.413-2.824 2.25 2.25 0 0 0-2.824 1.583l-.26 1.16a.75.75 0 0 1-1.415.487l.26-1.16a2.25 2.25 0 0 0-1.413-2.824 2.25 2.25 0 0 0-2.824 1.583L9.75 9.75v.63c0 .597.237 1.17.659 1.591l.26 1.159a.75.75 0 0 1-1.415.487l-.26-1.16A2.25 2.25 0 0 0 6 9.75v-.63a3.75 3.75 0 0 1 3.75-3.75z" />
    </svg>
);
